const ignoreTests = [
  ...
  "rollup@form@logical-expression@deopzimize-while-included: handles deoptimizations of logical expression while they are included (#3324)",
  "rollup@form@return-value-access-in-conditional: handles accessing function return values in deoptimized conditionals",
  "rollup@form@treeshake-json: removes unused json keys",
]
